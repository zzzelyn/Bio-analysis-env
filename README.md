...
* [1. 基础环境构建](#section1)
* [2. 核心软件安装](#section2 )
* [3. Jupyter Notebook 配置](#section3 )
* [4. 扩展包安装](#section4 )
* [5. 难点攻克：CellChat 安装](#section5 )
* [6. 验证与使用](#section6 )

---

## 1. 基础环境构建<a id="section1"></a>
...
## 2. 核心软件安装 (最关键步骤)<a id="section2"></a>
...
## 3. Jupyter Notebook 配置 (Kernel 注册)<a id="section3"></a>
...
## 5. 难点攻克：CellChat 安装<a id="section5"></a>
